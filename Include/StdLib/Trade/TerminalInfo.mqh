...
//+------------------------------------------------------------------+
//
// VENDORED — TradeSpine Include/StdLib/Trade/ (ADR-06)
// Source: MetaTrader 5 terminal Include/Trade/TerminalInfo.mqh
// Edits applied:
//   1. line-6 #include <Object.mqh> → #include "../Object.mqh"
//      (total-freeze Option A per PRD §7c)
//   2. include guard added (not in terminal original)
//
#ifndef TRADESPINE_VENDOR_TERMINAL_INFO_MQH
#define TRADESPINE_VENDOR_TERMINAL_INFO_MQH
...
//+------------------------------------------------------------------+
//| Access functions TerminalInfoInteger(...)                        |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
//| Access functions TerminalInfoString(...)                         |
//+------------------------------------------------------------------+
...
#endif // TRADESPINE_VENDOR_TERMINAL_INFO_MQH
//+------------------------------------------------------------------+
